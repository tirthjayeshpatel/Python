...
#method-1 print(round(pi,2))
#method-2- we will use this as it is asked in question.
# print("Value of pi is {}".format(pi))

# # using f-function formating float numbers 
# print("Value of pi is {:.1f}".format(pi)) = will round till 1 , 3.1
...
#8. Difference Between find() and index() in Python? find():

text = "hello world"

print(text.find("world"))  # Output: 6
print(text.find("xyz"))    # Output: -1  (no error!)

text = "hello world"

print(text.index("world"))  # Output: 6
print(text.index("xyz"))    #  Raises ValueError: substring not found
